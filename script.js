...
const Questions = [{
    ...
    a: [{ text: "the green goblin throwing her off a bridge", isCorrect: false },
    { text: "Spideriman shooting out a web and catching her but snaping her neck", isCorrect: true },
    { text: "Venom eating her", isCorrect: false },
    { text: "the joker blowing her up", isCorrect: false }
    ]
},
{
    id: 1,
